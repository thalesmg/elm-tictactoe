...
var _user$project$Main$joinMaybe = function (mma) {
	var _p0 = mma;
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
...
var _user$project$Main$viewPlayer = function (p) {
	var _p1 = p;
	if (_p1.ctor === 'X') {
		return 'X';
	} else {
...
var _user$project$Main$viewElement = function (element) {
	var el = _user$project$Main$joinMaybe(element);
	var _p2 = el;
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('');
	} else {
		return _elm_lang$html$Html$text(
			_user$project$Main$viewPlayer(_p2._0));
	}
};
...
var _user$project$Main$init = {
	...
	_0: {
		...
		turn: _user$project$Main$X
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$Main$nextTurn = function (turn) {
	var _p4 = turn;
	if (_p4.ctor === 'X') {
...
var _user$project$Main$play = F4(
	function (i, j, msg, model) {
		var currturn = model.turn;
		var array = model.arr;
		var element = _user$project$Main$joinMaybe(
			A2(
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						arr: A3(
							...
							{ctor: '_Tuple2', _0: i, _1: j},
							_elm_lang$core$Maybe$Just(currturn),
							array),
						turn: _user$project$Main$nextTurn(currturn)
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		return A4(_user$project$Main$play, _p6._0, _p6._1, msg, model);
	});
var _user$project$Main$Play = F2(
	function (a, b) {
		return {ctor: 'Play', _0: a, _1: b};
	});
var _user$project$Main$mkTable = function (m) {
	var element = F2(
		function (i, j) {
			return A2(
				_elm_lang$html$Html$td,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_user$project$Main$Play, i, j)),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '33'),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '33'),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _user$project$Main$viewElement(
						A2(
							_chendrix$elm_matrix$Matrix$get,
							{ctor: '_Tuple2', _0: i, _1: j},
							m)),
...
var _user$project$Main$view = function (model) {
	return _user$project$Main$mkTable(model.arr);
};
