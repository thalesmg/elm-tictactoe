...
var _user$project$Main$renderCell = function (element) {
...
var _user$project$Main$emptyArray = A2(
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {arr: _user$project$Main$emptyArray, turn: _user$project$Main$X},
	...
	var element = F2(
		function (i, j) {
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$renderCell(
						A2(
							_chendrix$elm_matrix$Matrix$get,
							{ctor: '_Tuple2', _0: i, _1: j},
							m)),
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$mkTable(model.arr),
			_1: {
				ctor: '::',
				_0: A2(
